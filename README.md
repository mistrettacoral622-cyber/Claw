...
Screenshot is implemented as a remote task that asks the remote agent to save a PNG artifact and return its path. This is a one-shot artifact workflow, not continuous screen sharing.
